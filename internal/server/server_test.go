...
import (
	...
	api "github.com/ldmtam/proglog/api/v1"
	"github.com/ldmtam/proglog/internal/auth"
	"github.com/ldmtam/proglog/internal/config"
	"github.com/ldmtam/proglog/internal/log"
...
func testUnauthorized(t *testing.T, _, client api.LogClient, config *Config) {
	...
	if produce != nil {
		t.Fatalf("produce repsonse should be nil")
	}
...
func setupTest(t *testing.T, fn func(*Config)) (
	...
	var telemeryExporter *exporter.LogExporter
	if *debug {
		...
		telemeryExporter, err = exporter.NewLogExporter(exporter.Options{
	...
	return rootClient, nobodyClient, cfg, func() {
		...
		l.Close()
		clog.Remove()
		if telemeryExporter != nil {
			time.Sleep(1500 * time.Millisecond)
			telemeryExporter.Stop()
			telemeryExporter.Close()
		}
	}
}
